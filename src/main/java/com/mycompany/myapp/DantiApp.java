...
public class DantiApp {

    private static final Logger log = LoggerFactory.getLogger(DantiApp.class);

    private final Environment env;

    public DantiApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DantiApp.class);
